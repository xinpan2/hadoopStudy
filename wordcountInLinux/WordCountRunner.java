...
public class WordCountRunner {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		// set the jar path,use the relative path
		...
		// "hdfs://xinpan2:9000/wc/srcdata");
		// FileOutputFormat.setOutputPath(wcjob, new
		// Path("hdfs://xinpan2:9000/wc/res"));
		FileInputFormat.setInputPaths(wcjob, "hdfs://xinpan2:9000/wc/srcdata");

		// if the output path already exist delete the file
		Path output = new Path("hdfs://xinpan2:9000/wc/res");
